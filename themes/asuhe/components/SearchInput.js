...
const SearchInput = ({ currentTag, currentSearch, cRef, className }) => {
  ...
  return <div className={'flex w-full rounded-2xl' + className}>
    <input
      ref={searchInputRef}
      type='text'
      className={'rounded-xl outline-none w-full text-sm pl-2 transition focus:shadow-lg font-light leading-10 text-black bg-asuhe-light-2 dark:bg-gray-900 dark:text-white'}
      onKeyUp={handleKeyUp}
